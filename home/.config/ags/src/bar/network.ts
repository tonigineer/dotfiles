...
const UPDATE_POLL = 1000;  // Calculation must be adapted, when not one second :)
const UPDATE_RENDER = 500;
    ...
    children: [
        Widget.Box({
            ...
            children: [Widget.Label({
                class_name: "value",
                label: "0.0",
                setup: self => self.poll(UPDATE_RENDER, () => {
